...
.block-container { padding: 2.1rem 1.2rem 3rem !important; max-width: 1180px; }
...
.pmo-header {
  ...
  flex-wrap: wrap; gap: 10px; margin-top: 8px; margin-bottom: 8px;
}
...
# ── MAIN LAYOUT ──
# בקשת המשתמש: אזור בחירת מסלולי ההשקעה יופיע מיד מתחת למסלולים הטהורים
